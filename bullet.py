...
class Bullet(Sprite):
    ...
    def __init__(self, ai_game):
        ...
        self.color = self.settings.bullet_color  # Bullet color.

        # Create a bullet rect at (0, 0) and then set correct position.
        self.rect = pygame.Rect(0, 0, self.settings.bullet_width,
            self.settings.bullet_height)
        self.rect.midtop = ai_game.ship.rect.midtop  # Position the bullet at the ship's current location.
    ...
    def draw_bullet(self):
        ...
        pygame.draw.rect(self.screen, self.color, self.rect)  # Draw the bullet on the screen.
